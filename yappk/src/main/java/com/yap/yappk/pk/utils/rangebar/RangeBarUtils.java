...
public class RangeBarUtils {
    ...
    public static Bitmap drawableToBitmap(Context context, int width, int height, int drawableId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            return RangeBarUtils.drawableToBitmap(width, height, context.getResources().getDrawable(drawableId, null));
        } else {
            return RangeBarUtils.drawableToBitmap(width, height, context.getResources().getDrawable(drawableId));
        }
    }
