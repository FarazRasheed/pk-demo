...
import com.yap.yappk.databinding.LayoutPhoneContactItemBinding
...
class PhoneContactListAdapter(
    ...
    BaseBindingSearchRecyclerAdapter<Contact, PhoneContactListAdapter.PhoneContactItemViewHolder>(
        list
    ) {
    override fun onCreateViewHolder(binding: ViewDataBinding): PhoneContactItemViewHolder {
        return PhoneContactItemViewHolder(binding)
    }

    override fun onBindViewHolder(holder: PhoneContactItemViewHolder, position: Int) {
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        } else R.layout.layout_phone_contact_item
    }

    override fun getItemCount(): Int = if (list.isNullOrEmpty()) 1 else list.size

    inner class PhoneContactItemViewHolder(private val binding: ViewDataBinding) :
        ...
        fun onBind(
            ...
            when (binding) {
                ...
                is LayoutPhoneContactItemBinding -> {
                    handlePhoneContactBinding(binding, data, position, onItemClickListener)
                }
            }
    ...
    private fun handlePhoneContactBinding(
        binding: LayoutPhoneContactItemBinding,
        data: Contact,
        position: Int,
        onItemClickListener: OnItemClickListener?
    ) {
