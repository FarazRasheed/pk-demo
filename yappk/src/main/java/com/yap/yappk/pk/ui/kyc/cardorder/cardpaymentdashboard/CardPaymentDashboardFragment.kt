...
import com.yap.yappk.databinding.PkFragmentCardPaymentDashboardBinding
...
import com.yap.yappk.pk.ui.kyc.cardorder.cardpaymentaddcard.CardPaymentAddCardFragment
...
@AndroidEntryPoint
class CardPaymentDashboardFragment :
    BaseNavFragment<PkFragmentCardPaymentDashboardBinding, ICardPaymentDashboard.State, ICardPaymentDashboard.ViewModel>(
        R.layout.pk_fragment_card_payment_dashboard
    ), ICardPaymentDashboard.View, ToolBarView.OnToolBarViewClickListener,
    ExternalCardPagerListener,
    ...
    override val viewModel: ICardPaymentDashboard.ViewModel by viewModels<CardPaymentDashboardVM>()
    ...
    override fun openAddCardScreen() {
        navigateForResult(
            resId = R.id.action_cardPaymentDashboardFragment_to_cardPaymentAddCardFragment,
            requestCode = ADD_EXTERNAL_CARD_REQUEST_CODE,
            bundleOf(CardPaymentAddCardFragment::class.java.name to true)
        )
    }

    override fun openCardDetailScreen() = Unit

    override fun openExternalCardTopUp(externalCard: ExternalCard?) {
        externalCard?.let {
            parentViewModel.externalCard = it
            navigate(R.id.action_cardPaymentDashboardFragment_to_addressSelectionFragment)
        }
    }
